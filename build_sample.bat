...
msbuild.exe SampleCpp\SampleCpp.sln /p:Configuration=Release /p:Platform=x64 > %workspace%\BuildSampleCpp.sln.Optimize.x64.!Inve.log 2>&1
msbuild.exe SampleCpp\SampleCpp.sln /p:Configuration=Debug /p:Platform=x64 > %workspace%\BuildSampleCpp.sln.Debug.x64.!Inve.log 2>&1
msbuild.exe SampleCpp\SampleCpp.sln /p:Configuration=Release /p:Platform=x86 > %workspace%\BuildSampleCpp.sln.Optimize.x86.!Inve.log 2>&1
msbuild.exe SampleCpp\SampleCpp.sln /p:Configuration=Debug /p:Platform=x86 > %workspace%\BuildSampleCpp.sln.Debug.x86.!Inve.log 2>&1
